...
Let's take this little example [config](docs/CONFIGURATION.md) for a check of two paths on otto.de:
...
This is the report, that is generated by the 'after' step You can see that several things changed between the two
JLineup runs:

[Example JLineup HTML Report](https://otto-de.github.io/jlineup/docs/example-report/report.html)
