...
Open a terminal and download it like this:
    ...
    wget https://repo1.maven.org/maven2/de/otto/jlineup-cli/5.0.1/jlineup-cli-5.0.1.jar -O jlineup.jar
...
JLineup 5.0.1 was tested successfully with latest Chrome and Firefox. If not installed,
