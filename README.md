...
Open a terminal and download it like this:
    ...
    wget https://repo1.maven.org/maven2/de/otto/jlineup-cli/6.0.0/jlineup-cli-6.0.0.jar -O jlineup.jar
...
JLineup 6.0.0 was tested successfully with latest Chrome and Firefox. If not installed,
