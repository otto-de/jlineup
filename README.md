...
## Status
[![Build](https://github.com/otto-de/jlineup/actions/workflows/build.yml/badge.svg)](https://github.com/otto-de/jlineup/actions/workflows/build.yml)
...
Open a terminal and download it like this:
    ...
    wget https://repo1.maven.org/maven2/de/otto/jlineup-cli/6.0.1/jlineup-cli-6.0.1.jar -O jlineup.jar
...
JLineup 6.0.2 was tested successfully with latest Chrome and Firefox. If not installed,
