...
public class UrlConfig {
    ...
    public static Builder copyOfBuilder(UrlConfig copy) {
        ...
        builder.browsers = copy.browsers;
    ...
    public static final class Builder {
        ...
        public Builder withStyle(String val) {
            style = val;
            return this;
        }
