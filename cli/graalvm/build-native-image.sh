...
-jar build/libs/jlineup-cli-4.14.2-all.jar
...
mv jlineup-cli-4.14.2-all build/libs/jlineup-cli-4.14.2-all
rm ~/.m2/repository/webdriver -rf
./build/libs/jlineup-cli-4.14.2-all -Dwdm.architecture=X64 --config graalvm/lineup_chrome_headless.json --step before

set +e

./build/libs/jlineup-cli-4.14.2-all -Dwdm.architecture=X64 --config graalvm/lineup_chrome_headless.json --step after
