...
`wget https://repo1.maven.org/maven2/de/otto/jlineup-cli-lambda/6.0.0/jlineup-cli-lambda-6.0.0.jar -O jlineup.jar`
...
`wget https://repo1.maven.org/maven2/de/otto/jlineup-web-lambda/6.0.0/jlineup-web-lambda-6.0.0.jar -O jlineup-web.jar`
