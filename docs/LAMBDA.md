...
`wget https://repo1.maven.org/maven2/de/otto/jlineup-cli-lambda/5.3.0/jlineup-cli-lambda-5.3.0.jar -O jlineup.jar`
...
`wget https://repo1.maven.org/maven2/de/otto/jlineup-web-lambda/5.3.0/jlineup-web-lambda-5.3.0.jar -O jlineup-web.jar`
