...
`wget https://repo1.maven.org/maven2/de/otto/jlineup-cli-lambda/6.0.4/jlineup-cli-lambda-6.0.4.jar -O jlineup.jar`
...
`wget https://repo1.maven.org/maven2/de/otto/jlineup-web-lambda/6.0.4/jlineup-web-lambda-6.0.4.jar -O jlineup-web.jar`
